...
@Component({
  selector: 'app-sherbert-list',
  templateUrl: './sherbert-list.component.html',
  styleUrls: ['./sherbert-list.component.css']
})
export class SherbertListComponent implements OnInit, OnDestroy {
  ...
  sherbertImage =  '../../../../assets/images/sherbert.jpg';
  ...
  sherbertSizeItem: IcecreamSizeItem[] = this.sherbert;
